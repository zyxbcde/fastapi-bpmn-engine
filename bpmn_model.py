...
from db_connector import finish_running_instance, add_running_instance, add_event
...
class BpmnInstance:
    ...
    async def run(self):
        ...
        while len(self.pending) > 0:
            ...
            for idx, current in enumerate(self.pending):
                ...
                if isinstance(current, StartEvent):
                    ...
                    await add_running_instance(instance_id=self._id)
        ...
        await finish_running_instance(self._id)
